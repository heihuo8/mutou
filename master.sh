#!/bin/bash
   hosts="
# Github Hosts\n\n
209.141.46.211 auth.cdnfly.cn\n
209.141.46.211 monitor.cdnfly.cn\n
# End of the section"
...
if [[ $VER == "" ]]; then
  # 获取最新版本
  echo "获取最新版..."
  latest_version=`curl -s 'http://update-cn.mutoujs.xyz/master/upgrades?latest=1' | grep -Po 'v\d+\.\d+.\d+' || true`
...
cd /opt/
download "https://github.com/heihuo8/mutou/raw/main/master/$tar_gz_name" "https://github.com/heihuo8/mutou/raw/main/master/$tar_gz_name" "$tar_gz_name"
